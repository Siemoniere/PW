...
-- Processes 
  ...
  Flag : array (0 .. Nr_Of_Processes - 1) of Boolean := (others => False);
  Turn : Integer := 0;
...
-- Types, procedures and functions
  ...
  task body Process_Task_Type is
   ...
   procedure Entry_Protocol is
      I : constant Integer := Process.Id;
      J : constant Integer := 1 - I;
   begin
      Flag(I) := True;
      Turn := J;
      while Flag(J) and Turn = J loop
         null;
      end loop;
   end Entry_Protocol;
